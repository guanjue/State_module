...
output_folder = args[6]#'kmeans_pairwise_motif_1d'
outputfile_transit_mat = args[7]#'kmeans_motif_1d'
heatmap_name = args[8]#'test.heatmap.1d.png'
add_smallnum = as.numeric(args[9])
...
transit_mat_pool_log2fc_plot = transit_mat_pool_bg_log2fc[order(all_counts_clust_clusters_id),][seq(1,dim(transit_mat_pool_bg_log2fc)[1], 20),]
